...
trainer.model.load_weights(
    './test_runs/17_DenseLinLinLadderVAE_contrastNorm/model.h5')
trainer.generator.load_weights(
    './test_runs/17_DenseLinLinLadderVAE_contrastNorm/generator_model.h5')
trainer.latent_model.load_weights(
    './test_runs/17_DenseLinLinLadderVAE_contrastNorm/latent_model.h5')
