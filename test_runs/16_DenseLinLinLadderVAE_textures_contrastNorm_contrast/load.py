...
trainer.model.load_weights(
    './test_runs/16_DenseLinLinLadderVAE_textures_contrastNorm_contrast/model.h5'
)
trainer.generator.load_weights(
    './test_runs/16_DenseLinLinLadderVAE_textures_contrastNorm_contrast/generator_model.h5'
)
trainer.latent_model.load_weights(
    './test_runs/16_DenseLinLinLadderVAE_textures_contrastNorm_contrast/latent_model.h5'
)
