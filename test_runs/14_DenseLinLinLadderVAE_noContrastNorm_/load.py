...
trainer.model.load_weights(
    './test_runs/14_DenseLinLinLadderVAE_noContrastNorm_/model.h5')
trainer.generator.load_weights(
    './test_runs/14_DenseLinLinLadderVAE_noContrastNorm_/generator_model.h5')
trainer.latent_model.load_weights(
    './test_runs/14_DenseLinLinLadderVAE_noContrastNorm_/latent_model.h5')
