...
conv_vae = LadderVAE(input_shape=(70, 28*28), latent_dim1=256, latent_dim2=64)

model_trainer = ModelTrainer(conv_vae, data_gen, loss_fn="normal", beta=1, lr=1e-4)
model_trainer.fit(10, 100)
